...
export const sitePages: SitePage[] = [
  ...
  { title: 'Choisir plateforme', href: 'choisir-plateforme', category: 'Méthode', description: 'Parcours guidé pour choisir entre PEA, CTO, courtier, N26, Revolut ou Trade Republic selon le besoin réel.', keywords: ['PEA', 'CTO', 'courtier', 'N26', 'Revolut', 'Trade Republic', 'choisir plateforme'] },
  ...
  { title: 'Méthodologie', href: 'methodologie', category: 'Bases', description: 'Méthode éditoriale : sources, hypothèses, limites et vérifications avant décision.', keywords: ['méthodologie', 'sources', 'hypothèses', 'fiabilité'] },
